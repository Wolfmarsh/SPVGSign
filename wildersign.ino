    ...
    case 1:
      ...
      switch (randNumber) {
        ...
        case 15:
          ...
          break;
        case 16:
          Sparkle(strip.Color(0, 0, 0, 255), 5); //do a stadium photography effect
          break;
        case 17:
          Sparkle(strip.Color(random(50,255), random(50,255), random(50,255), 0), random(0,10)); //do a random color stadium photography effect
          break;
      }
      state = 2;
      break;
